    ...
    forms: {
      ...
      application: {
        ...
        sitemap: {
          ...
          'кадровые-документы': {
            caption: 'Кадровые_документы',
            title: 'Кадровые_документы',
...
define('ember-app/mixins/regenerated/models/i-i-s-finalnyjj-proekt-\u043E\u0442\u0434\u0435\u043B\u044B', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ОтделыL', 'i-i-s-finalnyjj-proekt-отделы', {
      код: (0, _attributes.attr)('Код', { index: 0 }),
      наименование: (0, _attributes.attr)('Наименование', { index: 1 }),
      организации: (0, _attributes.belongsTo)('i-i-s-finalnyjj-proekt-организации', 'Название', {
...
define('ember-app/mixins/regenerated/models/i-i-s-finalnyjj-proekt-\u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0438', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('СотрудникиL', 'i-i-s-finalnyjj-proekt-сотрудники', {
      ...
      отделы: (0, _attributes.belongsTo)('i-i-s-finalnyjj-proekt-отделы', 'Наименование', {
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-finalnyjj-proekt-организации': 'id,код,название',
        'i-i-s-finalnyjj-proekt-отделы': 'id,код,наименование,организации',
        ...
        'i-i-s-finalnyjj-proekt-сотрудники': 'id,id,имя,номерПас,отчество,серияПас,фамилия,должности,отделы'
      });
