...
moduleForModel('i-i-s-finalnyjj-proekt-организации', 'Unit | Serializer | i-i-s-finalnyjj-proekt-организации', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-finalnyjj-proekt-организации',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
    ...
    'model:i-i-s-finalnyjj-proekt-организации',
